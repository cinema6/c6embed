...
var $location = (function(Location) {
    'use strict';
    return new Location({ window: window, document: document });
}(require('../src/app/utils/Location')));
...
function loadAnalyticsJS(name) {
    ...
    })(window,document,'script',$location.protocol+'//www.google-analytics.com/analytics.js',name);
}
