module.exports = function(deps) {
    ...
    function extend() {
        return Array.prototype.slice.call(arguments).reduce(function(result, object) {
    ...
    _private.makeAdCall = function(card, experience, pixels, placement, adtech) {
    ...
    this.fetchSponsoredCards = function(experience, pixels) {
        ...
        return _private.loadAdtech().then(function(adtech) {
            ...
            return q.all(sponsoredCards.map(function(card) {
                return _private.makeAdCall(card, experience, pixels, placement, adtech);
            }));
