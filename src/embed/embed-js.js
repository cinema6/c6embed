...
function c6embed(beforeElement, params) {
    ...
    return Player.getParams(params, {
        ...
        function createSplash() {
            ...
            var splashHtmlUrl = resolveUrl(
                apiRoot,
                '/collateral/splash/' + params.splash.type + '/' +
            ...
            function loadBranding(branding, splash) {
                ...
                if (branding && !document.getElementById(id)) {
                    ...
                    link.href = resolveUrl(
                        apiRoot,
                        '/collateral/branding/' + branding + '/styles/splash.css'
                    );
            ...
            return importScripts([splashJsUrl, splashHtmlUrl]).spread(function createSplash(
                splashJs,
                splashHtml
            ) {
                var splashDelegate;
