describe('logger', function() {
    ...
    it('should export the constructor of the default logger', function() {
        expect(Logger).toBe(logger.constructor);
    });
    ...
    describe('properties:', function() {
        describe('tasks', function() {
            ...
            describe('.format', function() {
                describe('[0]', function() {
                    beforeEach(function() {
                        fn = logger.tasks.format[0];
                    });

                    it('should convert non-strings using utils.inspect', function() {
                        expect(
                            fn(logger, 'log', [true, false, 11, 'hello world', undefined, null, { hello: 'world' }])
                        ).toEqual(
